...
//send email
function AddRenterNotification(email, name, asset, admin ) {
  var email = email;
  var asset = asset;
  var name = name;
  var admin = admin;
  ...
  let mailOptions = {
    ...
    subject: "Renter Registration", // Subject line
    html: `<!doctype html>
  <html lang="en-US">
                              ...
                              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                  ...
                                  <tr>
                                      <td style="padding:0 35px;">
                                          ...
                                          ${asset} has been succesfully rented to you from ${admin}.follow the following link to view the asset and complete your registration 
                                            </p>
                                          <p><b>
...
module.exports = AddRenterNotification;
